...
competitions = CSV.open("csv/scripps_competitions_2008.csv","r")
results = CSV.open("csv/scripps_results_2008.csv","w")

#base = "https://web.archive.org"

#'//*[@id="copyBody"]/table/tr[position()>1]'
path = "/html/body/table/tr/td[2]/table/tr[position()>1]"
