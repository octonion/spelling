...
results = CSV.open("csv/scripps_competitions_2013.csv","w")
...
url = 'https://web.archive.org/web/20150401074613/http://spellingbee.com:80/public/results/2013/round_results'
